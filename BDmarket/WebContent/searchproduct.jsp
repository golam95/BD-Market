			...
			<div class="col-md-12 col-sm-12">
				...
				<div class="col-md-9 col-sm-9">
					<div class="section-showproduct-right">
						<%
							String category = "";
							category = request.getParameter("productName");
							if (category != null) {
								CustomerServiceImp shopservice = new CustomerServiceImp();
								if (shopservice.check_Categorymatch(category)) {
									for (Post p : shopservice.searchpostbyCategory(category)) {
						%>
						<div class="section-element">
							<div class="col-md-3 col-sm-3">
								<img src="img/about/1.jpg" alt="ICON-PAY">
							</div>
							<div class="col-md-4 col-sm-4">
								<h4 style="font-weight: bold; color: black;font-size:15px;">
									Product Name:
									<%=p.getProductname()%></h4>
								<h6 style="font-weight: bold; color: black; font-size: 14px;">
									Type of Shop:
									<%=p.getTypeofshop()%></h6>
									<h6
						...
						%>
						<h2 style="font-size: 25px;">Sorry,The following product post
							are not available!!!</h2>
