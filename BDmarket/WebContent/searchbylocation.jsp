			...
			<div class="col-md-12 col-sm-12">
				...
				<div class="col-md-9 col-sm-9">
					<div class="section-showproduct-right">
						<%
							String category = "";
							category = request.getParameter("searchValue");
							if (category != null) {
								CustomerServiceImp shopservice = new CustomerServiceImp();
								if (shopservice.check_Locationmatch(category)) {
									for (Post p : shopservice.searchpostbyLocation(category)) {
						%>
						<div class="section-element">
							...
							<div class="col-md-2 col-sm-2">
								<h5 style="margin-top: 10px;font-weigth: bold;">Quantity</h5>
						...
						%>
						<h2 style="font-size: 25px;">Sorry,No Product found this
							location!!!</h2>
