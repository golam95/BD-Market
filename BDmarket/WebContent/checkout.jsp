				...
				<div class="col-md-9 col-sm-9">
					<div class="section-showproduct-right">
						<div class="col-md-offset-1 col-md-10">
							<h4 style="margin-bottom: 30px;">Product Detail's</h4>
							<%
								String error = "";
							...
							<%
								...
								Cart c = cusdservice.getCart(cartId);
							%>
							...
							<form action="ManageCustomer" method="POST">
								...
								<input type="hidden" name="getpostId" value="<%=c.getProductId() %>" />
								
								<input
									type="hidden" name="ownerEmail" value="<%=c.getOwneremail()%>" />
								<input type="hidden" name="imglink" value="<%=c.getImlink()%>" />
								<input type="hidden" name="cartId" value="<%=c.getCartId()%>" />

								<div class="form-group">
									<label for="inputUserName">Product Name</label> <input
										style="border: 1px solid #74B54D; width: 650px;"
										class="form-control" placeholder="Login Username" type="text"
										name="productname" value="<%=c.getProductName()%>" />
								</div>
								<div class="form-group">
									<label for="inputUserName">Description</label> <input
										style="border: 1px solid #74B54D; width: 650px;"
										class="form-control" placeholder="Login Username" type="text"
										name="prodouctDescription" value="<%=c.getDescription()%>"
										readonly />
								</div>
								<div class="form-group">
									<label for="inputUserName">Quantity</label> <input
										style="border: 1px solid #74B54D; width: 650px;"
										class="form-control" placeholder="Login Username" type="text"
										name="productQuantity" value="<%=c.getQuantity()%>" readonly />
								</div>
								<div class="form-group">
									<label for="inputUserName">Price(TK)</label> <input
										style="border: 1px solid #74B54D; width: 650px;"
										class="form-control" placeholder="Login Username" type="text"
										name="productPrice" value="<%=c.getPrice()%>" readonly />
								</div>

								<h4 style="margin-bottom: 30px; margin-top: 30px;">Your
									Details</h4>
								<%
									CustomerServiceImp customerservice = new CustomerServiceImp();
									List<Customer> customerlist = customerservice.getcustomerList(username);
									for (Customer cus : customerlist) {
								%>
								<div class="form-group">
									<label for="inputUserName">Enter your address</label> <input
										style="border: 1px solid #74B54D; width: 650px;"
								...
								<div class="form-group">
									<label for="inputUserName">Email</label> <input
										style="border: 1px solid #74B54D; width: 650px;"
										class="form-control" placeholder="Login Username" type="text"
										name="customerEmail" value="<%=cus.getCus_phone()%>" />
								</div>
								<div class="form-group">
									<label for="inputUserName">Contact No</label> <input
										style="border: 1px solid #74B54D; width: 650px;"
										class="form-control" placeholder="Login Username" type="text"
										name="customerContactNo" value="<%=cus.getCus_password()%>" />
								</div>
								<%
									}
								%>
								<div class="form-group">
									...
									<button
										style="padding: 5px; width: 300px; background: #74B54D; color: #FFFFFF; margin-top: 20px;"
