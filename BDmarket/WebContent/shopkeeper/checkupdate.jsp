...
<div style="height: 70px;" class="content-slidebar">
	<div class="col-md-12"></div>
</div>
<%
				...
				<div class="container">
					<div class="col-xs-12 col-md-4 col-md-offset-4">
						<div class="emty_cart_inner">
							<i style="color: #74B54D;" class="fa fa-user-secret"> <span
								style="color: #74B54D;" class="glyphicon glyphicon-user"></span></i>
							<h3 style="color: red;">Please Update your profile</h3>
							<h4>
								<a style="color: #57992E;" href="#" data-target="#loginModal"
									data-toggle="modal">Update your profile</a>
							</h4>
						</div>
					</div>
			</section>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="modal" id="loginModal" tabindex="-1">
				<div style="width: 500px; margin-top: 80px;" class="modal-dialog">
					<div class="modal-content">
						<div style="background: #74B54D;" class="modal-header">
							<button class="close" data-dismiss="modal">&times;</button>
							<h4 style="color: #FFFFFF; font-size: 17px;" class="modal-title">
								<span style="padding-left: 5px;"> <span
									class="glyphicon glyphicon-user"></span> Update Your Profile
								</span>
							</h4>
						</div>

						<form action="../Manage_reg" method="POST">
							<input type="hidden" name="action" value="UPDATE_PROFILE" /> <input
								type="hidden" name="shopkeeperEmail" value="<%=username%>" />
							<div class="modal-body">
								<div class="form-group">
									<label for="inputUserName">Shop Name</label> <input
										style="border: 1px solid #74B54D;" class="form-control"
										placeholder="Enter your shop name" type="text" name="u_name"
										required />
								</div>

								<div class="form-group">
									<label for="inputUserName">Shop Location</label> <select
										style="border: 1px solid #74B54D; height: 35px; margin-bottom: 18px;"
										class="form-control" name="u_location" required>
										<option></option>
								...
								<div class="form-group">
									<label for="inputUserName">Type of Shop</label> <select
										class="form-control" name="u_type" required>
										<option></option>
										<%
										...
										%>
										<option value="<%=m.getShopcategory()%>"><%=m.getShopcategory()%></option>
										<%
											}
										%>
									</select>
								...
								<div class="form-group">
									<label for="inputUserName">All product Name</label> <input
										style="border: 1px solid #74B54D;" class="form-control"
										placeholder="Enter product name" type="text" name="u_product"
										required />
								</div>
							</div>
							<div class="modal-footer">
								<button style="background: #57992E; border: 1px solid #57992E"
									class="btn btn-primary" id="updateprofile">Save</button>
								<button style="background: #57992E; border: 1px solid #57992E"
